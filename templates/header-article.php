  ...
  <div class="row">
    <div class="col m12 l4">
      <div class="title-header">
        <a href="http://miferdang.freetzi.com"><h1> Mifer's Articles </h1></a>
        <p class="left"> Những bài viết dưới dây chủ yếu nhằm phục vụ mục đích nghiên cứu và tự học là chính ! </p>
      </div>
    </div>
...
<nav class="list-menu">
  <div class="container">
    ...
    <ul class="left hide-on-med-and-down">
      <?php wp_nav_menu(array( 'theme_location' => 'article_menu' )); ?>
    </ul>
